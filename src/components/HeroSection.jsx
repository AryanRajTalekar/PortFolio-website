  ...
  return (
    ...
    >
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-2-2xl mx-auto opacity-0 animate-fade-in-delay-3">
            Information Technology enthusiast with experience in Java, MERN stack, and Machine Learning.
      ...
      <div className=" absolute bottom-0 left-1/2 transform -translate-x-1/2 flex flex-col items-center animate-bounce">
        <span className="text-lg text-mutedd-foreground mb-2">Scroll</span>
